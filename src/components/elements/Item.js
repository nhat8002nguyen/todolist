...
export default function Item({ id, name, description,isIgnored, onIgnore, onDelete }) {
  ...
  return (
    <div className={classes.root}>
      <Checkbox checked={checked} onChange={handleCheckbox} inputProps={{'aria-lable': 'primary checkbox'}} />
      <Typography
